...
export const ca: TranslationStructure = {
    ...
    settingsAppearance: {
        ...
        showVoiceInput: 'Botó d\'entrada de veu',
        showVoiceInputDescription: 'Mostra el botó del micròfon al camp del missatge',
    ...
    session: {
        ...
        queuedAttachment: 'Fitxer adjunt en cua',
    ...
    sessionInfo: {
        ...
        resumeSessionRequiresUpgrade: 'Actualitza Happy CLI en aquesta màquina per activar la represa.',
        resumeSessionThreadUnavailable: 'Aquest dispositiu ja no té aquesta conversa de Codex.',
        resumeSessionExternalThreadActive: 'Aquesta conversa de Codex està activa fora de Happy. Atura-la abans de tornar-ho a provar.',
        resumeSessionGatewayRecovering: 'El Gateway anterior encara s\'està recuperant. Torna-ho a provar d\'aquí a poc.',
        resumeSessionInvalidBinding: 'Aquesta sessió desada ja no coincideix amb la conversa de Codex.',
        resumeSessionOutcomeUnknown: 'La sol·licitud de represa pot continuar en execució. Actualitza i torna-ho a provar.',
        resumeSessionOperationFailed: 'No s\'ha pogut reprendre la sessió. Torna-ho a provar.',
        resumeSessionBrowseDevice: 'Explora converses recuperables en aquest dispositiu',
        resumeSessionBrowseDeviceSubtitle: 'Obre el directori original i tria una altra conversa de Codex disponible.',
    ...
    agentInput: {
        ...
        context: {
            ...
            detailsTitle: 'Ús del context',
            usage: ({ used, total, percent }: { used: string; total: string; percent: number }) => `Context: ${used} de ${total} tokens, ${percent}%`,
            remainingTokens: ({ remaining }: { remaining: string }) => `Tokens restants: ${remaining}`,
        },
        suggestion: {
            fileLabel: 'FITXER',
            folderLabel: 'CARPETA',
    ...
    settingsAccount: {
        ...
        deleteAccountSubtitle: 'Suprimeix permanentment totes les dades del compte Happy. Aquesta acció no es pot desfer.',
        deleteAccountConfirm: 'Vols suprimir ara totes les dades del compte Happy? Aquesta acció no es pot desfer i tancarà la sessió a tots els dispositius.',
        deleteAccountFailed: 'No s\'ha pogut iniciar la supressió del compte. El teu compte continua disponible.',
        deleteAccountUncertain: 'El servidor pot estar processant la teva sol·licitud de supressió. Ara se suprimiran les dades locals; no assumeixis que el compte continua disponible.',
        logout: 'Tanca la sessió',
    ...
    machine: {
        ...
        openSessionInDirectory: 'Obre una sessió al directori',
        pathPlaceholder: 'Introdueix un camí',
        resumeThreadAction: 'Obre una conversa anterior de Codex',
        resumeThreadActionHint: 'Tria un fil oficial de Codex d’aquest directori',
        startNewSessionAction: 'Inicia una conversa nova de Codex',
        resumeRequiresUpgradeTitle: 'Cal actualitzar la CLI',
        resumeRequiresUpgradeMessage: 'Actualitza Happy CLI i reinicia el dimoni per consultar converses anteriors de Codex.',
        resumeThreadTitle: 'Obre una conversa anterior de Codex',
        resumeThreadSearch: 'Cerca converses',
        resumeBindingScanFailed: 'No s’han pogut comprovar els enllaços de sessions de Happy.',
        resumeThreadListFailed: 'No s’ha pogut carregar l’historial de converses de Codex.',
        resumeThreadOpenFailed: 'No s’ha pogut obrir la conversa de Codex.',
        resumeSessionRefreshFailed: 'La sessió s’ha obert a la màquina, però l’App encara no l’ha pogut carregar. Torna-ho a provar quan es recuperi la connexió.',
        resumeCheckingBindings: 'Comprovant els enllaços de sessions de Happy…',
        resumeThreadEmpty: 'No s’han trobat converses de Codex sense arxivar en aquest directori.',
        resumeMaterialUnavailable: 'El dimoni no ha pogut recuperar les dades xifrades per reprendre aquesta sessió.',
        resumeLoadMore: 'Carrega’n més',
        resumeThreadConfirm: 'Obre la conversa',
        resumeDuplicateBinding: 'Hi ha més d’una sessió de Happy enllaçada a aquesta conversa de Codex. Resol el duplicat abans d’obrir-la.',
        resumeLegacyBlocked: 'Aquesta sessió de Happy usa xifratge antic i no pot transferir de manera segura les dades de represa.',
        resumeExternalActiveBlocked: 'Aquesta conversa de Codex està activa fora de Happy. Atura-la allà abans d’obrir-la des de l’App.',
        resumeSourceCli: 'CLI',
        resumeSourceVscode: 'VS Code',
        resumeSourceExec: 'Exec',
        resumeSourceAppServer: 'App Server',
        resumeSourceUnknown: 'Origen desconegut',
        resumeExternalThread: 'No enllaçada a Happy',
        resumeDuplicate: 'Enllaç duplicat',
        resumeHappyActive: 'Sessió de Happy activa',
        resumeHappyInactive: 'Sessió de Happy inactiva',
        resumeProviderActive: 'Codex actiu',
        daemon: 'Dimoni',
        status: 'Estat',
    ...
    message: {
        ...
        sessionCleared: 'Finestra de sessió nova',
