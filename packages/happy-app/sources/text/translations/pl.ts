...
export const pl: TranslationStructure = {
    ...
    status: {
        ...
        unknown: 'nieznane',
        unread: 'nowe wyniki',
        gatewayStarting: 'Uruchamianie Gateway',
        gatewayRecovering: 'Odzyskiwanie Gateway',
        gatewayStopping: 'Zatrzymywanie Gateway',
        gatewayStopped: 'Gateway zatrzymany',
        gatewaySwitching: 'Przełączanie sesji',
        gatewaySyncing: 'Synchronizowanie Gateway',
        terminalAttached: 'Terminal podłączony',
        terminalPendingDetach: 'Ponowne łączenie terminala',
        terminalDetached: 'Terminal odłączony',
        gatewayHeadless: 'Sterowanie z aplikacji',
    },
    ...
    session: {
        ...
        queuedAttachment: 'Załącznik w kolejce',
    ...
    sessionInfo: {
        ...
        stopGateway: 'Zatrzymaj Gateway',
        stopGatewayConfirm: 'Zatrzymać ten Codex Gateway? Historia rozmowy pozostanie dostępna.',
        stopGatewayFailed: 'Nie udało się zatrzymać Codex Gateway.',
    ...
    tools: {
        ...
        names: {
            ...
            codexControl: 'Sterowanie Codex',
            codexActivity: 'Aktywność Codex',
        },
        desc: {
    ...
    machine: {
        ...
        openSessionInDirectory: 'Otwórz sesję w katalogu',
        pathPlaceholder: 'Wpisz ścieżkę',
        resumeThreadAction: 'Otwórz poprzednią rozmowę Codex',
        resumeThreadActionHint: 'Wybierz oficjalny wątek Codex z tego katalogu',
        startNewSessionAction: 'Rozpocznij nową rozmowę Codex',
        resumeRequiresUpgradeTitle: 'Wymagana aktualizacja CLI',
        resumeRequiresUpgradeMessage: 'Zaktualizuj Happy CLI i uruchom ponownie demona, aby przeglądać poprzednie rozmowy Codex.',
        resumeThreadTitle: 'Otwórz poprzednią rozmowę Codex',
        resumeThreadSearch: 'Szukaj rozmów',
        resumeBindingScanFailed: 'Nie udało się sprawdzić powiązań sesji Happy.',
        resumeThreadListFailed: 'Nie udało się wczytać historii rozmów Codex.',
        resumeThreadOpenFailed: 'Nie udało się otworzyć rozmowy Codex.',
        resumeSessionRefreshFailed: 'Sesja została otwarta na maszynie, ale aplikacja nie może jej jeszcze wczytać. Spróbuj ponownie po przywróceniu połączenia.',
        resumeCheckingBindings: 'Sprawdzanie powiązań sesji Happy…',
        resumeThreadEmpty: 'W tym katalogu nie znaleziono niezarchiwizowanych rozmów Codex.',
        resumeMaterialUnavailable: 'Demon nie mógł odzyskać zaszyfrowanych danych potrzebnych do wznowienia tej sesji.',
        resumeLoadMore: 'Wczytaj więcej',
        resumeThreadConfirm: 'Otwórz rozmowę',
        resumeDuplicateBinding: 'Z tą rozmową Codex powiązano więcej niż jedną sesję Happy. Usuń duplikat przed otwarciem.',
        resumeLegacyBlocked: 'Ta sesja Happy używa starszego szyfrowania i nie może bezpiecznie przekazać danych wznowienia.',
        resumeExternalActiveBlocked: 'Ta rozmowa Codex jest aktywna poza Happy. Zatrzymaj ją tam przed otwarciem w aplikacji.',
        resumeSourceCli: 'CLI',
        resumeSourceVscode: 'VS Code',
        resumeSourceExec: 'Exec',
        resumeSourceAppServer: 'App Server',
        resumeSourceUnknown: 'Nieznane źródło',
        resumeExternalThread: 'Niepowiązana z Happy',
        resumeDuplicate: 'Duplikat powiązania',
        resumeHappyActive: 'Sesja Happy aktywna',
        resumeHappyInactive: 'Sesja Happy nieaktywna',
        resumeProviderActive: 'Codex aktywny',
        daemon: 'Daemon',
        status: 'Status',
    ...
    message: {
        ...
        contextCompaction: 'Kontekst skompresowany',
        reviewStarted: 'Przegląd rozpoczęty',
        reviewFinished: 'Przegląd zakończony',
    },
