...
export const pl: TranslationStructure = {
    ...
    settingsAppearance: {
        ...
        showVoiceInput: 'Przycisk wprowadzania głosowego',
        showVoiceInputDescription: 'Pokaż przycisk mikrofonu w polu wiadomości',
    ...
    sessionInfo: {
        ...
        resumeSessionRequiresUpgrade: 'Zaktualizuj Happy CLI na tej maszynie, aby włączyć wznawianie.',
        resumeSessionThreadUnavailable: 'To urządzenie nie ma już tej rozmowy Codex.',
        resumeSessionExternalThreadActive: 'Ta rozmowa Codex jest aktywna poza Happy. Zatrzymaj ją przed ponowieniem próby.',
        resumeSessionGatewayRecovering: 'Poprzedni Gateway nadal się odzyskuje. Spróbuj ponownie za chwilę.',
        resumeSessionInvalidBinding: 'Ta zapisana sesja nie pasuje już do rozmowy Codex.',
        resumeSessionOutcomeUnknown: 'Żądanie wznowienia może nadal trwać. Odśwież i spróbuj ponownie.',
        resumeSessionOperationFailed: 'Nie udało się wznowić sesji. Spróbuj ponownie.',
        resumeSessionBrowseDevice: 'Przeglądaj rozmowy możliwe do wznowienia na tym urządzeniu',
        resumeSessionBrowseDeviceSubtitle: 'Otwórz pierwotny katalog i wybierz inną dostępną rozmowę Codex.',
    ...
    agentInput: {
        ...
        context: {
            ...
            detailsTitle: 'Wykorzystanie kontekstu',
            usage: ({ used, total, percent }: { used: string; total: string; percent: number }) => `Kontekst: ${used} z ${total} tokenów, ${percent}%`,
            remainingTokens: ({ remaining }: { remaining: string }) => `Pozostało tokenów: ${remaining}`,
        },
        suggestion: {
            fileLabel: 'PLIK',
            folderLabel: 'FOLDER',
    ...
    tools: {
        ...
        requestResponse: {
            awaitingInput: 'Oczekiwanie na odpowiedź',
            submitting: 'Wysyłanie',
            awaitingConfirmation: 'Oczekiwanie na potwierdzenie',
            retryableError: 'Nie udało się wysłać',
            outcomeUnknownStatus: 'Wynik nieznany',
            unavailableStatus: 'Niedostępne',
            submitFailed: 'Nie udało się wysłać tej odpowiedzi. Sprawdź wybór i spróbuj ponownie.',
            outcomeUnknown: 'Codex mógł otrzymać tę odpowiedź. Poczekaj na aktualizację żądania przed ponowną odpowiedzią.',
            unavailable: 'To żądanie nie jest już dostępne.',
        }
    },
    ...
    settingsAccount: {
        ...
        deleteAccountSubtitle: 'Trwale usuń wszystkie dane konta Happy. Tej operacji nie można cofnąć.',
        deleteAccountConfirm: 'Usunąć teraz wszystkie dane konta Happy? Tej operacji nie można cofnąć, a nastąpi wylogowanie na wszystkich urządzeniach.',
        deleteAccountFailed: 'Nie udało się rozpocząć usuwania konta. Konto jest nadal dostępne.',
        deleteAccountUncertain: 'Serwer może przetwarzać żądanie usunięcia. Dane lokalne zostaną teraz wyczyszczone; nie zakładaj, że konto jest nadal dostępne.',
        logout: 'Wyloguj',
    ...
    message: {
        ...
        sessionCleared: 'Nowe okno sesji',
