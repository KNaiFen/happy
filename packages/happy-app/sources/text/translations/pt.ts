...
export const pt: TranslationStructure = {
    ...
    status: {
        ...
        resumePending: 'aguardando verificação',
        archived: 'arquivada',
        ...
        gatewayStopping: 'Parando Gateway',
        gatewayStopped: 'Gateway parado',
        gatewaySwitching: 'Alternando sessão',
        ...
        gatewayHeadless: 'Controle pelo app',
    },
    ...
    settings: {
        ...
        about: 'Sobre',
        aboutFooter: 'Happy Coder é um cliente móvel para Codex. É totalmente criptografado ponta a ponta e sua conta é armazenada apenas no seu dispositivo.',
        whatsNew: 'Novidades',
    ...
    server: {
        ...
        allowInsecureHttpSubtitle: 'Somente em redes confiáveis. HTTPS continua recomendado.',
        webHttpLocalhostOnly: 'Navegadores Web só permitem relés HTTP em localhost. Use HTTPS para servidores remotos.',
        insecureHttpConfirmTitle: 'Ativar HTTP inseguro?',
        insecureHttpConfirmBody: 'Continue somente em uma rede confiável. Um invasor ativo pode roubar seu token, falsificar confirmações, se passar pelo servidor e observar metadados de transporte. A criptografia de ponta a ponta não impede esses ataques.',
        enableInsecureHttp: 'Ativar HTTP',
        httpOrHttpsOnly: 'A URL do servidor deve usar HTTP ou HTTPS.',
        urlCredentialsNotAllowed: 'A URL do servidor não pode conter usuário ou senha.',
        urlQueryNotAllowed: 'A URL do servidor não pode conter uma string de consulta.',
        urlFragmentNotAllowed: 'A URL do servidor não pode conter um fragmento.',
        enableInsecureHttpFirst: 'Ative HTTP inseguro antes de usar este servidor.',
    },
    ...
    sessionInfo: {
        ...
        stopGatewayConfirm: 'Parar este Gateway do Codex? O histórico da conversa continuará disponível.',
        stopGatewayFailed: 'Não foi possível parar o Gateway do Codex.',
        ...
        resumeSessionPendingVerification: 'Estamos verificando se esta sessão pode ser retomada.',
        resumeSessionSameMachineOnly: 'This session can only be resumed on the same machine it started on.',
        resumeSessionMachineOffline: 'This machine is offline. Resume is only available while it is online.',
        resumeSessionNeedsHappyAgent: 'Resume is unavailable on this machine. Run `happy-agent auth login` to enable it.',
        resumeSessionMissingMachine: 'This session is missing its machine metadata, so it cannot be resumed.',
        resumeSessionMissingCodexThread: 'Esta sessão não possui uma thread Codex que possa ser retomada.',
        resumeSessionUnexpectedDirectoryPrompt: 'Resume cannot create directories. Start the session manually from its original path.',
        resumeSessionRequiresUpgrade: 'Atualize o Happy CLI nesta máquina para habilitar Retomar.',
        resumeSessionThreadUnavailable: 'Este dispositivo não tem mais esta conversa Codex.',
        resumeSessionExternalThreadActive: 'Esta conversa Codex está ativa fora do Happy. Pare-a antes de tentar novamente.',
        resumeSessionGatewayRecovering: 'O Gateway anterior ainda está se recuperando. Tente novamente em breve.',
        resumeSessionInvalidBinding: 'Esta sessão salva não corresponde mais à conversa Codex.',
        resumeSessionOutcomeUnknown: 'A solicitação de retomada pode ainda estar em execução. Atualize e tente novamente.',
        resumeSessionOperationFailed: 'Não foi possível retomar a sessão. Tente novamente.',
        resumeSessionBrowseDevice: 'Ver conversas recuperáveis neste dispositivo',
        resumeSessionBrowseDeviceSubtitle: 'Abra o diretório original e escolha outra conversa Codex disponível.',
    ...
    tools: {
        ...
        names: {
            ...
            codexControl: 'Controle do Codex',
            codexActivity: 'Atividade do Codex',
        },
        desc: {
    ...
    settingsAccount: {
        ...
        deleteAccountSubtitle: 'Exclua permanentemente todos os dados da conta Happy. Esta ação não pode ser desfeita.',
        deleteAccountConfirm: 'Excluir agora todos os dados da conta Happy? Esta ação não pode ser desfeita e encerrará a sessão em todos os dispositivos.',
        deleteAccountFailed: 'Não foi possível iniciar a exclusão da conta. Sua conta continua disponível.',
        deleteAccountUncertain: 'O servidor pode estar processando sua solicitação de exclusão. Os dados locais serão limpos agora; não presuma que a conta continua disponível.',
        logout: 'Sair',
    ...
    machine: {
        ...
        openSessionInDirectory: 'Abrir uma sessão no diretório',
        pathPlaceholder: 'Digite um caminho',
        resumeThreadAction: 'Abrir conversa anterior do Codex',
        resumeThreadActionHint: 'Escolha uma thread oficial do Codex neste diretório',
        startNewSessionAction: 'Iniciar nova conversa do Codex',
        resumeRequiresUpgradeTitle: 'Atualização da CLI necessária',
        resumeRequiresUpgradeMessage: 'Atualize a Happy CLI e reinicie o daemon para consultar conversas anteriores do Codex.',
        resumeThreadTitle: 'Abrir conversa anterior do Codex',
        resumeThreadSearch: 'Pesquisar conversas',
        resumeBindingScanFailed: 'Não foi possível verificar os vínculos das sessões Happy.',
        resumeThreadListFailed: 'Não foi possível carregar o histórico de conversas do Codex.',
        resumeThreadOpenFailed: 'Não foi possível abrir a conversa do Codex.',
        resumeSessionRefreshFailed: 'A sessão foi aberta na máquina, mas o App ainda não conseguiu carregá-la. Tente novamente após a conexão ser restabelecida.',
        resumeCheckingBindings: 'Verificando vínculos das sessões Happy…',
        resumeThreadEmpty: 'Nenhuma conversa do Codex não arquivada foi encontrada neste diretório.',
        resumeMaterialUnavailable: 'O daemon não conseguiu recuperar os dados criptografados para retomar esta sessão.',
        resumeLoadMore: 'Carregar mais',
        resumeThreadConfirm: 'Abrir conversa',
        resumeDuplicateBinding: 'Mais de uma sessão Happy está vinculada a esta conversa do Codex. Resolva a duplicidade antes de abri-la.',
        resumeLegacyBlocked: 'Esta sessão Happy usa criptografia legada e não pode transferir os dados de retomada com segurança.',
        resumeExternalActiveBlocked: 'Esta conversa do Codex está ativa fora do Happy. Pare-a lá antes de abrir pelo App.',
        resumeSourceCli: 'CLI',
        resumeSourceVscode: 'VS Code',
        resumeSourceExec: 'Exec',
        resumeSourceAppServer: 'App Server',
        resumeSourceUnknown: 'Origem desconhecida',
        resumeExternalThread: 'Não vinculada ao Happy',
        resumeDuplicate: 'Vínculo duplicado',
        resumeHappyActive: 'Sessão Happy ativa',
        resumeHappyInactive: 'Sessão Happy inativa',
        resumeProviderActive: 'Codex ativo',
        daemon: 'Daemon',
        status: 'Status',
