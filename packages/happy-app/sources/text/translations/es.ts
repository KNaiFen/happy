...
export const es: TranslationStructure = {
    ...
    status: {
        ...
        resumePending: 'pendiente de verificación',
        archived: 'archivada',
    ...
    settingsAppearance: {
        ...
        showVoiceInput: 'Botón de entrada de voz',
        showVoiceInputDescription: 'Mostrar el botón del micrófono en el cuadro de mensaje',
    ...
    sessionHistory: {
        ...
        resumePending: 'Pendientes de verificación',
    },
    ...
    session: {
        ...
        queuedMessageEdit: 'Editar mensaje en cola',
        queuedMessageSteer: 'Enviar al turno activo',
        queuedMessageSteerCompact: 'Guiar',
        queuedMessageRemove: 'Eliminar mensaje en cola',
        queuedMessageMore: 'Más acciones del mensaje en cola',
        queuedMessageActionFailed: 'No se pudo actualizar el mensaje en cola. Es posible que su estado haya cambiado; inténtalo de nuevo.',
    ...
    sessionInfo: {
        ...
        resumeSessionPendingVerification: 'Se está verificando si esta sesión se puede reanudar.',
        ...
        resumeSessionRequiresUpgrade: 'Actualiza Happy CLI en esta máquina para habilitar Reanudar.',
        resumeSessionThreadUnavailable: 'Este dispositivo ya no tiene esta conversación de Codex.',
        resumeSessionExternalThreadActive: 'Esta conversación de Codex está activa fuera de Happy. Detenla allí antes de reintentar.',
        resumeSessionGatewayRecovering: 'El Gateway anterior aún se está recuperando. Inténtalo de nuevo pronto.',
        resumeSessionInvalidBinding: 'Esta sesión guardada ya no coincide con su conversación de Codex.',
        resumeSessionOutcomeUnknown: 'La solicitud de reanudación puede seguir ejecutándose. Actualiza e inténtalo de nuevo.',
        resumeSessionOperationFailed: 'No se pudo reanudar la sesión. Inténtalo de nuevo.',
        resumeSessionBrowseDevice: 'Explorar conversaciones recuperables en este dispositivo',
        resumeSessionBrowseDeviceSubtitle: 'Abre el directorio original y elige otra conversación de Codex disponible.',
    ...
    tools: {
        ...
        names: {
            ...
            codexActivity: 'Actividad de Codex',
        },
        desc: {
    ...
    settingsAccount: {
        ...
        deleteAccountSubtitle: 'Elimina permanentemente todos los datos de la cuenta Happy. Esta acción no se puede deshacer.',
        deleteAccountConfirm: '¿Eliminar ahora todos los datos de la cuenta Happy? Esta acción no se puede deshacer y cerrará la sesión en todos los dispositivos.',
        deleteAccountFailed: 'No se pudo iniciar la eliminación de la cuenta. Tu cuenta sigue disponible.',
        deleteAccountUncertain: 'El servidor puede estar procesando tu solicitud de eliminación. Los datos locales se borrarán ahora; no des por hecho que la cuenta sigue disponible.',
        logout: 'Cerrar sesión',
    ...
    machine: {
        ...
        openSessionInDirectory: 'Abrir una sesión en el directorio',
        pathPlaceholder: 'Introduce una ruta',
        resumeThreadAction: 'Abrir conversación anterior de Codex',
        resumeThreadActionHint: 'Elige un hilo oficial de Codex de este directorio',
        startNewSessionAction: 'Iniciar nueva conversación de Codex',
        resumeRequiresUpgradeTitle: 'Se requiere actualizar la CLI',
        resumeRequiresUpgradeMessage: 'Actualiza Happy CLI y reinicia el daemon para explorar conversaciones anteriores de Codex.',
        resumeThreadTitle: 'Abrir conversación anterior de Codex',
        resumeThreadSearch: 'Buscar conversaciones',
        resumeBindingScanFailed: 'No se pudieron comprobar los vínculos de sesiones de Happy.',
        resumeThreadListFailed: 'No se pudo cargar el historial de conversaciones de Codex.',
        resumeThreadOpenFailed: 'No se pudo abrir la conversación de Codex.',
        resumeSessionRefreshFailed: 'La sesión se abrió en la máquina, pero la App todavía no pudo cargarla. Vuelve a intentarlo cuando se restablezca la conexión.',
        resumeCheckingBindings: 'Comprobando vínculos de sesiones de Happy…',
        resumeThreadEmpty: 'No se encontraron conversaciones de Codex sin archivar en este directorio.',
        resumeMaterialUnavailable: 'El daemon no pudo recuperar los datos cifrados para reanudar esta sesión.',
        resumeLoadMore: 'Cargar más',
        resumeThreadConfirm: 'Abrir conversación',
        resumeDuplicateBinding: 'Hay más de una sesión de Happy vinculada a esta conversación de Codex. Resuelve el duplicado antes de abrirla.',
        resumeLegacyBlocked: 'Esta sesión de Happy usa cifrado antiguo y no puede transferir los datos de reanudación de forma segura.',
        resumeExternalActiveBlocked: 'Esta conversación de Codex está activa fuera de Happy. Detenla allí antes de abrirla desde la App.',
        resumeSourceCli: 'CLI',
        resumeSourceVscode: 'VS Code',
        resumeSourceExec: 'Exec',
        resumeSourceAppServer: 'App Server',
        resumeSourceUnknown: 'Origen desconocido',
        resumeExternalThread: 'Sin vincular a Happy',
        resumeDuplicate: 'Vínculo duplicado',
        resumeHappyActive: 'Sesión de Happy activa',
        resumeHappyInactive: 'Sesión de Happy inactiva',
        resumeProviderActive: 'Codex activo',
        daemon: 'Daemon',
        status: 'Estado',
    ...
    message: {
        ...
        sessionCleared: 'Nueva ventana de sesión',
        reviewStarted: 'Revisión iniciada',
        reviewFinished: 'Revisión finalizada',
    },
