...
export const zhHant: TranslationStructure = {
    ...
    settings: {
        ...
        about: '關於',
        aboutFooter: 'Happy Coder 是一個 Codex 行動用戶端。它採用端對端加密，您的帳戶僅儲存在本機裝置上。',
        whatsNew: '更新日誌',
    ...
    sessionInfo: {
        ...
        resumeSessionMissingCodexThread: '此工作階段沒有可恢復的 Codex 執行緒。',
        resumeSessionUnexpectedDirectoryPrompt: 'Resume cannot create directories. Start the session manually from its original path.',
        resumeSessionRequiresUpgrade: '請更新此裝置上的 Happy CLI 後再恢復工作階段。',
        resumeSessionThreadUnavailable: '目前裝置上已無此 Codex 對話。',
        resumeSessionExternalThreadActive: '此 Codex 對話正在 Happy 外部執行，請先停止後再試。',
        resumeSessionGatewayRecovering: '上一個 Gateway 正在恢復，請稍後再試。',
        resumeSessionInvalidBinding: '此儲存的工作階段已不再對應其 Codex 對話。',
        resumeSessionOutcomeUnknown: '恢復請求可能仍在執行。請重新整理後再試。',
        resumeSessionOperationFailed: '無法恢復此工作階段，請再試一次。',
        resumeSessionBrowseDevice: '瀏覽此裝置上的可恢復對話',
        resumeSessionBrowseDeviceSubtitle: '開啟原始目錄並選擇另一個可用的 Codex 對話。',
    ...
    settingsVoice: {
        ...
        byoTitle: '使用自己的代理',
        byoDescription: '使用您自己的 ElevenLabs 代理取代 Happy 預設代理。無需訂閱 — 直接使用您自己的 ElevenLabs 帳戶連線。您的代理必須定義兩個用戶端工具：sendMessageToSession（向編碼代理傳送文字）和 processPermissionRequest（允許或拒絕工具使用）。透過 {{initialConversationContext}} 動態變數接收工作階段上下文。',
    ...
    settingsAccount: {
        ...
        dangerZone: '危險區域',
        deleteAccount: '刪除帳戶',
        deleteAccountSubtitle: '永久刪除全部 Happy 帳戶資料。此操作無法撤銷。',
        deleteAccountConfirm: '現在刪除全部 Happy 帳戶資料？此操作無法撤銷，並會讓您的所有裝置登出。',
        deleteAccountFailed: '無法開始刪除帳戶。您的帳戶仍可使用。',
        deleteAccountUncertain: '伺服器可能正在處理您的刪除請求。本機資料將立即清除；請不要假定該帳戶仍可使用。',
        logout: '登出',
    ...
    machine: {
        ...
        openSessionInDirectory: '在目錄中開啟工作階段',
        pathPlaceholder: '輸入路徑',
        resumeThreadAction: '開啟過往 Codex 對話',
        resumeThreadActionHint: '選擇此目錄中的官方 Codex 執行緒',
        startNewSessionAction: '新增 Codex 對話',
        resumeRequiresUpgradeTitle: '需要更新 CLI',
        resumeRequiresUpgradeMessage: '請更新 Happy CLI 並重新啟動守護程序，然後再瀏覽過往 Codex 對話。',
        resumeThreadTitle: '開啟過往 Codex 對話',
        resumeThreadSearch: '搜尋對話',
        resumeBindingScanFailed: '無法核對 Happy 工作階段綁定。',
        resumeThreadListFailed: '無法載入 Codex 對話記錄。',
        resumeThreadOpenFailed: '無法開啟 Codex 對話。',
        resumeSessionRefreshFailed: '機器已開啟該工作階段，但 App 暫時無法載入。請在連線恢復後重試。',
        resumeCheckingBindings: '正在核對 Happy 工作階段綁定…',
        resumeThreadEmpty: '此目錄中沒有未封存的 Codex 對話。',
        resumeMaterialUnavailable: '守護程序無法恢復此工作階段的加密恢復資料。',
        resumeLoadMore: '載入更多',
        resumeThreadConfirm: '開啟對話',
        resumeDuplicateBinding: '此 Codex 對話綁定了多個 Happy 工作階段，請先處理重複綁定。',
        resumeLegacyBlocked: '此 Happy 工作階段使用舊版加密，無法安全傳遞恢復資料。',
        resumeExternalActiveBlocked: '此 Codex 對話正在 Happy 外部執行，請先在原位置停止後再從 App 開啟。',
        resumeSourceCli: '命令列',
        resumeSourceVscode: 'VS Code',
        resumeSourceExec: 'Exec',
        resumeSourceAppServer: 'App Server',
        resumeSourceUnknown: '未知來源',
        resumeExternalThread: '尚未連結 Happy',
        resumeDuplicate: '重複綁定',
        resumeHappyActive: 'Happy 工作階段活躍',
        resumeHappyInactive: 'Happy 工作階段未活躍',
        resumeProviderActive: 'Codex 正在執行',
