...
export const ja: TranslationStructure = {
    ...
    sessionInfo: {
        ...
        resumeSessionRequiresUpgrade: '再開を有効にするには、このマシンの Happy CLI を更新してください。',
        resumeSessionThreadUnavailable: 'このデバイスにはこの Codex 会話がもうありません。',
        resumeSessionExternalThreadActive: 'この Codex 会話は Happy の外部で実行中です。停止してから再試行してください。',
        resumeSessionGatewayRecovering: '前の Gateway はまだ復旧中です。しばらくしてから再試行してください。',
        resumeSessionInvalidBinding: '保存されたセッションは Codex 会話と一致しなくなりました。',
        resumeSessionOutcomeUnknown: '再開要求はまだ実行中の可能性があります。更新して再試行してください。',
        resumeSessionOperationFailed: 'セッションを再開できませんでした。再試行してください。',
        resumeSessionBrowseDevice: 'このデバイスの再開可能な会話を表示',
        resumeSessionBrowseDeviceSubtitle: '元のディレクトリを開き、利用可能な別の Codex 会話を選択します。',
    ...
    settingsAccount: {
        ...
        deleteAccountSubtitle: 'すべての Happy アカウントデータを完全に削除します。この操作は取り消せません。',
        deleteAccountConfirm: '今すぐすべての Happy アカウントデータを削除しますか？この操作は取り消せず、すべてのデバイスでサインアウトされます。',
        deleteAccountFailed: 'アカウントの削除を開始できませんでした。アカウントは引き続き利用できます。',
        deleteAccountUncertain: 'サーバーが削除リクエストを処理している可能性があります。ローカルデータは今すぐ消去されます。このアカウントが引き続き利用できるとは判断しないでください。',
        logout: 'ログアウト',
    ...
    machine: {
        ...
        openSessionInDirectory: 'ディレクトリでセッションを開く',
        pathPlaceholder: 'パスを入力',
        resumeThreadAction: '過去の Codex 会話を開く',
        resumeThreadActionHint: 'このディレクトリの公式 Codex スレッドを選択',
        startNewSessionAction: '新しい Codex 会話を開始',
        resumeRequiresUpgradeTitle: 'CLI の更新が必要です',
        resumeRequiresUpgradeMessage: 'Happy CLI を更新してデーモンを再起動すると、過去の Codex 会話を参照できます。',
        resumeThreadTitle: '過去の Codex 会話を開く',
        resumeThreadSearch: '会話を検索',
        resumeBindingScanFailed: 'Happy セッションの関連付けを確認できませんでした。',
        resumeThreadListFailed: 'Codex の会話履歴を読み込めませんでした。',
        resumeThreadOpenFailed: 'Codex の会話を開けませんでした。',
        resumeSessionRefreshFailed: 'マシンではセッションが開かれましたが、App はまだ読み込めません。接続の復旧後に再試行してください。',
        resumeCheckingBindings: 'Happy セッションの関連付けを確認中…',
        resumeThreadEmpty: 'このディレクトリに未アーカイブの Codex 会話はありません。',
        resumeMaterialUnavailable: 'デーモンはこのセッションの暗号化された再開情報を復元できませんでした。',
        resumeLoadMore: 'さらに読み込む',
        resumeThreadConfirm: '会話を開く',
        resumeDuplicateBinding: 'この Codex 会話には複数の Happy セッションが関連付けられています。重複を解消してください。',
        resumeLegacyBlocked: 'この Happy セッションは旧式の暗号化を使用しているため、再開情報を安全に転送できません。',
        resumeExternalActiveBlocked: 'この Codex 会話は Happy の外部で実行中です。元の場所で停止してから開いてください。',
        resumeSourceCli: 'CLI',
        resumeSourceVscode: 'VS Code',
        resumeSourceExec: 'Exec',
        resumeSourceAppServer: 'App Server',
        resumeSourceUnknown: '不明なソース',
        resumeExternalThread: 'Happy 未連携',
        resumeDuplicate: '重複した関連付け',
        resumeHappyActive: 'Happy セッションは実行中',
        resumeHappyInactive: 'Happy セッションは停止中',
        resumeProviderActive: 'Codex は実行中',
