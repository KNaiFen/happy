...
export const ru: TranslationStructure = {
    ...
    machine: {
        ...
        openSessionInDirectory: 'Открыть сессию в папке',
        pathPlaceholder: 'Введите путь',
        resumeThreadAction: 'Открыть прошлый диалог Codex',
        resumeThreadActionHint: 'Выберите официальный поток Codex из этой папки',
        startNewSessionAction: 'Начать новый диалог Codex',
        resumeRequiresUpgradeTitle: 'Требуется обновление CLI',
        resumeRequiresUpgradeMessage: 'Обновите Happy CLI и перезапустите демон, чтобы просматривать прошлые диалоги Codex.',
        resumeThreadTitle: 'Открыть прошлый диалог Codex',
        resumeThreadSearch: 'Поиск диалогов',
        resumeBindingScanFailed: 'Не удалось проверить привязки сессий Happy.',
        resumeThreadListFailed: 'Не удалось загрузить историю диалогов Codex.',
        resumeThreadOpenFailed: 'Не удалось открыть диалог Codex.',
        resumeSessionRefreshFailed: 'Сессия открыта на машине, но приложение пока не может её загрузить. Повторите попытку после восстановления соединения.',
        resumeCheckingBindings: 'Проверка привязок сессий Happy…',
        resumeThreadEmpty: 'В этой папке нет неархивированных диалогов Codex.',
        resumeMaterialUnavailable: 'Демон не смог восстановить зашифрованные данные для возобновления этой сессии.',
        resumeLoadMore: 'Загрузить ещё',
        resumeThreadConfirm: 'Открыть диалог',
        resumeDuplicateBinding: 'К этому диалогу Codex привязано несколько сессий Happy. Устраните дубликат перед открытием.',
        resumeLegacyBlocked: 'Эта сессия Happy использует устаревшее шифрование и не может безопасно передать данные возобновления.',
        resumeExternalActiveBlocked: 'Этот диалог Codex активен вне Happy. Остановите его там перед открытием в приложении.',
        resumeSourceCli: 'CLI',
        resumeSourceVscode: 'VS Code',
        resumeSourceExec: 'Exec',
        resumeSourceAppServer: 'App Server',
        resumeSourceUnknown: 'Неизвестный источник',
        resumeExternalThread: 'Не привязан к Happy',
        resumeDuplicate: 'Дублирующая привязка',
        resumeHappyActive: 'Сессия Happy активна',
        resumeHappyInactive: 'Сессия Happy неактивна',
        resumeProviderActive: 'Codex активен',
        daemon: 'Daemon',
        status: 'Статус',
