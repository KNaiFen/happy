...
export const ru: TranslationStructure = {
    ...
    settingsAppearance: {
        ...
        showVoiceInput: 'Кнопка голосового ввода',
        showVoiceInputDescription: 'Показывать кнопку микрофона в поле сообщения',
    ...
    sessionInfo: {
        ...
        resumeSessionRequiresUpgrade: 'Обновите Happy CLI на этой машине, чтобы включить возобновление.',
        resumeSessionThreadUnavailable: 'На этом устройстве больше нет этого диалога Codex.',
        resumeSessionExternalThreadActive: 'Этот диалог Codex активен вне Happy. Остановите его там перед повторной попыткой.',
        resumeSessionGatewayRecovering: 'Предыдущий Gateway всё ещё восстанавливается. Повторите попытку позже.',
        resumeSessionInvalidBinding: 'Эта сохранённая сессия больше не соответствует диалогу Codex.',
        resumeSessionOutcomeUnknown: 'Запрос на возобновление может всё ещё выполняться. Обновите данные и повторите попытку.',
        resumeSessionOperationFailed: 'Не удалось возобновить сессию. Повторите попытку.',
        resumeSessionBrowseDevice: 'Просмотреть доступные для восстановления диалоги на этом устройстве',
        resumeSessionBrowseDeviceSubtitle: 'Откройте исходный каталог и выберите другой доступный диалог Codex.',
    ...
    agentInput: {
        ...
        context: {
            ...
            detailsTitle: 'Использование контекста',
            usage: ({ used, total, percent }: { used: string; total: string; percent: number }) => `Контекст: ${used} из ${total} токенов, ${percent}%`,
            remainingTokens: ({ remaining }: { remaining: string }) => `Осталось токенов: ${remaining}`,
        },
        suggestion: {
            fileLabel: 'ФАЙЛ',
            folderLabel: 'ПАПКА',
    ...
    settingsAccount: {
        ...
        deleteAccountSubtitle: 'Безвозвратно удалить все данные аккаунта Happy. Это действие нельзя отменить.',
        deleteAccountConfirm: 'Удалить все данные аккаунта Happy сейчас? Это действие нельзя отменить, и вы выйдете из аккаунта на всех устройствах.',
        deleteAccountFailed: 'Не удалось начать удаление аккаунта. Ваш аккаунт по-прежнему доступен.',
        deleteAccountUncertain: 'Сервер может обрабатывать запрос на удаление. Локальные данные будут очищены сейчас; не считайте, что аккаунт по-прежнему доступен.',
        logout: 'Выйти',
    ...
    message: {
        ...
        sessionCleared: 'Новое окно сессии',
