...
export const it: TranslationStructure = {
    ...
    status: {
        ...
        resumePending: 'in attesa di verifica',
        archived: 'archiviata',
    ...
    settings: {
        ...
        about: 'Informazioni',
        aboutFooter: 'Happy Coder è un client mobile per Codex. È completamente cifrato end-to-end e il tuo account è memorizzato solo sul tuo dispositivo.',
        whatsNew: 'Novità',
    ...
    settingsAppearance: {
        ...
        showVoiceInput: 'Pulsante di input vocale',
        showVoiceInputDescription: 'Mostra il pulsante del microfono nel campo del messaggio',
    ...
    session: {
        ...
        queuedAttachment: 'Allegato in coda',
    ...
    server: {
        ...
        allowInsecureHttpSubtitle: 'Solo per reti attendibili. HTTPS resta consigliato.',
        webHttpLocalhostOnly: 'I browser Web consentono relay HTTP solo su localhost. Usa HTTPS per i server remoti.',
        insecureHttpConfirmTitle: 'Abilitare HTTP non sicuro?',
        insecureHttpConfirmBody: 'Continua solo su una rete attendibile. Un attaccante attivo può rubare il token, falsificare conferme, impersonare il server e osservare i metadati di trasporto. La crittografia end-to-end non impedisce questi attacchi.',
        enableInsecureHttp: 'Abilita HTTP',
        httpOrHttpsOnly: 'L’URL del server deve usare HTTP o HTTPS.',
        urlCredentialsNotAllowed: 'L’URL del server non può contenere nome utente o password.',
        urlQueryNotAllowed: 'L’URL del server non può contenere una stringa di query.',
        urlFragmentNotAllowed: 'L’URL del server non può contenere un frammento.',
        enableInsecureHttpFirst: 'Abilita HTTP non sicuro prima di usare questo server.',
    },
    ...
    sessionInfo: {
        ...
        resumeSessionPendingVerification: 'È in corso la verifica della possibilità di riprendere questa sessione.',
        resumeSessionSameMachineOnly: 'This session can only be resumed on the same machine it started on.',
        resumeSessionMachineOffline: 'This machine is offline. Resume is only available while it is online.',
        resumeSessionNeedsHappyAgent: 'Resume is unavailable on this machine. Run `happy-agent auth login` to enable it.',
        resumeSessionMissingMachine: 'This session is missing its machine metadata, so it cannot be resumed.',
        resumeSessionMissingCodexThread: 'Questa sessione non ha un thread Codex ripristinabile.',
        resumeSessionUnexpectedDirectoryPrompt: 'Resume cannot create directories. Start the session manually from its original path.',
        resumeSessionRequiresUpgrade: 'Aggiorna Happy CLI su questa macchina per abilitare Riprendi.',
        resumeSessionThreadUnavailable: 'Questo dispositivo non ha più questa conversazione Codex.',
        resumeSessionExternalThreadActive: 'Questa conversazione Codex è attiva fuori da Happy. Fermala prima di riprovare.',
        resumeSessionGatewayRecovering: 'Il Gateway precedente è ancora in ripristino. Riprova a breve.',
        resumeSessionInvalidBinding: 'Questa sessione salvata non corrisponde più alla conversazione Codex.',
        resumeSessionOutcomeUnknown: 'La richiesta di ripresa potrebbe essere ancora in corso. Aggiorna e riprova.',
        resumeSessionOperationFailed: 'Impossibile riprendere la sessione. Riprova.',
        resumeSessionBrowseDevice: 'Sfoglia le conversazioni recuperabili su questo dispositivo',
        resumeSessionBrowseDeviceSubtitle: 'Apri la directory originale e scegli un\'altra conversazione Codex disponibile.',
    ...
    agentInput: {
        ...
        context: {
            ...
            detailsTitle: 'Utilizzo del contesto',
            usage: ({ used, total, percent }: { used: string; total: string; percent: number }) => `Contesto: ${used} di ${total} token, ${percent}%`,
            remainingTokens: ({ remaining }: { remaining: string }) => `Token rimanenti: ${remaining}`,
        },
        suggestion: {
            fileLabel: 'FILE',
    ...
    settingsAccount: {
        ...
        deleteAccountSubtitle: 'Elimina definitivamente tutti i dati dell account Happy. Questa azione non può essere annullata.',
        deleteAccountConfirm: 'Eliminare ora tutti i dati dell account Happy? Questa azione non può essere annullata e disconnetterà tutti i dispositivi.',
        deleteAccountFailed: 'Non è stato possibile avviare l\'eliminazione dell\'account. Il tuo account è ancora disponibile.',
        deleteAccountUncertain: 'Il server potrebbe elaborare la richiesta di eliminazione. I dati locali verranno cancellati ora; non presumere che l\'account sia ancora disponibile.',
        logout: 'Esci',
    ...
    machine: {
        ...
        openSessionInDirectory: 'Apri una sessione nella directory',
        pathPlaceholder: 'Inserisci un percorso',
        resumeThreadAction: 'Apri una conversazione Codex precedente',
        resumeThreadActionHint: 'Scegli un thread Codex ufficiale di questa directory',
        startNewSessionAction: 'Avvia una nuova conversazione Codex',
        resumeRequiresUpgradeTitle: 'Aggiornamento CLI richiesto',
        resumeRequiresUpgradeMessage: 'Aggiorna Happy CLI e riavvia il daemon per sfogliare le conversazioni Codex precedenti.',
        resumeThreadTitle: 'Apri una conversazione Codex precedente',
        resumeThreadSearch: 'Cerca conversazioni',
        resumeBindingScanFailed: 'Impossibile verificare i collegamenti delle sessioni Happy.',
        resumeThreadListFailed: 'Impossibile caricare la cronologia delle conversazioni Codex.',
        resumeThreadOpenFailed: 'Impossibile aprire la conversazione Codex.',
        resumeSessionRefreshFailed: 'La sessione è stata aperta sulla macchina, ma l’App non riesce ancora a caricarla. Riprova quando la connessione sarà ripristinata.',
        resumeCheckingBindings: 'Verifica dei collegamenti delle sessioni Happy…',
        resumeThreadEmpty: 'Nessuna conversazione Codex non archiviata trovata in questa directory.',
        resumeMaterialUnavailable: 'Il daemon non ha potuto recuperare i dati crittografati per riprendere questa sessione.',
        resumeLoadMore: 'Carica altro',
        resumeThreadConfirm: 'Apri conversazione',
        resumeDuplicateBinding: 'Più sessioni Happy sono collegate a questa conversazione Codex. Risolvi il duplicato prima di aprirla.',
        resumeLegacyBlocked: 'Questa sessione Happy usa una crittografia precedente e non può trasferire in sicurezza i dati di ripresa.',
        resumeExternalActiveBlocked: 'Questa conversazione Codex è attiva fuori da Happy. Arrestala lì prima di aprirla dall’App.',
        resumeSourceCli: 'CLI',
        resumeSourceVscode: 'VS Code',
        resumeSourceExec: 'Exec',
        resumeSourceAppServer: 'App Server',
        resumeSourceUnknown: 'Origine sconosciuta',
        resumeExternalThread: 'Non collegata a Happy',
        resumeDuplicate: 'Collegamento duplicato',
        resumeHappyActive: 'Sessione Happy attiva',
        resumeHappyInactive: 'Sessione Happy inattiva',
        resumeProviderActive: 'Codex attivo',
    ...
    message: {
        ...
        sessionCleared: 'Nuova finestra di sessione',
