...
export const zhHans: TranslationStructure = {
    ...
    sessionInfo: {
        ...
        resumeSessionRequiresUpgrade: '请更新此设备上的 Happy CLI 后再恢复会话。',
        resumeSessionThreadUnavailable: '当前设备已无此 Codex 对话。',
        resumeSessionExternalThreadActive: '此 Codex 对话正在 Happy 外部运行，请先在原处停止后重试。',
        resumeSessionGatewayRecovering: '上一个 Gateway 正在恢复，请稍后重试。',
        resumeSessionInvalidBinding: '此保存的会话已不再匹配对应的 Codex 对话。',
        resumeSessionOutcomeUnknown: '恢复请求可能仍在执行。请刷新后重试。',
        resumeSessionOperationFailed: '无法恢复此会话，请重试。',
        resumeSessionBrowseDevice: '查看此设备中的可恢复对话',
        resumeSessionBrowseDeviceSubtitle: '打开原目录并选择另一个可用的 Codex 对话。',
    ...
    settingsAccount: {
        ...
        dangerZone: '危险区域',
        deleteAccount: '删除账户',
        deleteAccountSubtitle: '永久删除全部 Happy 账户数据。此操作无法撤销。',
        deleteAccountConfirm: '现在删除全部 Happy 账户数据？此操作无法撤销，并会让您的所有设备退出登录。',
        deleteAccountFailed: '无法启动账户删除。您的账户仍可用。',
        deleteAccountUncertain: '服务器可能正在处理您的删除请求。本地数据将立即清除；请不要假定该账户仍可用。',
        logout: '登出',
    ...
    machine: {
        ...
        openSessionInDirectory: '在目录中打开会话',
        pathPlaceholder: '输入路径',
        resumeThreadAction: '打开过往 Codex 对话',
        resumeThreadActionHint: '选择此目录中的官方 Codex 线程',
        startNewSessionAction: '新建 Codex 对话',
        resumeRequiresUpgradeTitle: '需要更新 CLI',
        resumeRequiresUpgradeMessage: '请更新 Happy CLI 并重启守护进程，然后再浏览过往 Codex 对话。',
        resumeThreadTitle: '打开过往 Codex 对话',
        resumeThreadSearch: '搜索对话',
        resumeBindingScanFailed: '无法核对 Happy 会话绑定。',
        resumeThreadListFailed: '无法载入 Codex 对话历史。',
        resumeThreadOpenFailed: '无法打开 Codex 对话。',
        resumeSessionRefreshFailed: '机器已打开该会话，但 App 暂时无法加载。请在连接恢复后重试。',
        resumeCheckingBindings: '正在核对 Happy 会话绑定…',
        resumeThreadEmpty: '此目录中没有未归档的 Codex 对话。',
        resumeMaterialUnavailable: '守护进程无法恢复此会话的加密恢复材料。',
        resumeLoadMore: '加载更多',
        resumeThreadConfirm: '打开对话',
        resumeDuplicateBinding: '此 Codex 对话绑定了多个 Happy 会话，请先处理重复绑定。',
        resumeLegacyBlocked: '此 Happy 会话使用旧版加密，无法安全传递恢复材料。',
        resumeExternalActiveBlocked: '此 Codex 对话正在 Happy 外部运行，请先在原位置停止后再从 App 打开。',
        resumeSourceCli: '命令行',
        resumeSourceVscode: 'VS Code',
        resumeSourceExec: 'Exec',
        resumeSourceAppServer: 'App Server',
        resumeSourceUnknown: '未知来源',
        resumeExternalThread: '尚未连接 Happy',
        resumeDuplicate: '重复绑定',
        resumeHappyActive: 'Happy 会话活跃',
        resumeHappyInactive: 'Happy 会话未活跃',
        resumeProviderActive: 'Codex 正在运行',
