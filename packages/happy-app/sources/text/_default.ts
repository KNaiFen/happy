...
export const en = {
    ...
    sessionInfo: {
        ...
        resumeSessionRequiresUpgrade: 'Update the Happy CLI on this machine to enable Resume.',
        resumeSessionThreadUnavailable: 'This device no longer has this Codex conversation.',
        resumeSessionExternalThreadActive: 'This Codex conversation is active outside Happy. Stop it there before retrying.',
        resumeSessionGatewayRecovering: 'The previous Gateway is still recovering. Try again shortly.',
        resumeSessionInvalidBinding: 'This saved session no longer matches its Codex conversation.',
        resumeSessionOutcomeUnknown: 'The resume request may still be running. Refresh and try again.',
        resumeSessionOperationFailed: 'The session could not be resumed. Try again.',
        resumeSessionBrowseDevice: 'Browse recoverable conversations on this device',
        resumeSessionBrowseDeviceSubtitle: 'Open the original directory and choose another available Codex conversation.',
    ...
    settingsAccount: {
        ...
        deleteAccountSubtitle: 'Permanently delete all Happy account data. This cannot be undone.',
        deleteAccountConfirm: 'Delete all Happy account data now? This cannot be undone and signs you out on every device.',
        deleteAccountFailed: 'Account deletion could not be started. Your account is still available.',
        deleteAccountUncertain: 'The server may be processing your deletion request. Local data will be cleared now; do not assume this account is still available.',
        logout: 'Logout',
    ...
    machine: {
        ...
        openSessionInDirectory: 'Open a Session in Directory',
        pathPlaceholder: 'Enter a path',
        resumeThreadAction: 'Open past Codex conversation',
        resumeThreadActionHint: 'Choose an official Codex thread from this directory',
        startNewSessionAction: 'Start new Codex conversation',
        resumeRequiresUpgradeTitle: 'CLI update required',
        resumeRequiresUpgradeMessage: 'Update Happy CLI and restart the daemon to browse past Codex conversations.',
        resumeThreadTitle: 'Open Past Codex Conversation',
        resumeThreadSearch: 'Search conversations',
        resumeBindingScanFailed: 'Happy session bindings could not be checked.',
        resumeThreadListFailed: 'Codex conversation history could not be loaded.',
        resumeThreadOpenFailed: 'The Codex conversation could not be opened.',
        resumeSessionRefreshFailed: 'The session was opened on the machine, but the App could not load it yet. Retry after the connection recovers.',
        resumeCheckingBindings: 'Checking Happy session bindings…',
        resumeThreadEmpty: 'No unarchived Codex conversations were found in this directory.',
        resumeMaterialUnavailable: 'The daemon could not recover the encrypted resume material for this session.',
        resumeLoadMore: 'Load more',
        resumeThreadConfirm: 'Open conversation',
        resumeDuplicateBinding: 'More than one Happy session is bound to this Codex conversation. Resolve the duplicate before opening it.',
        resumeLegacyBlocked: 'This Happy session uses legacy encryption and cannot securely transfer resume material.',
        resumeExternalActiveBlocked: 'This Codex conversation is active outside Happy. Stop it there before opening it from the App.',
        resumeSourceCli: 'CLI',
        resumeSourceVscode: 'VS Code',
        resumeSourceExec: 'Exec',
        resumeSourceAppServer: 'App Server',
        resumeSourceUnknown: 'Unknown source',
        resumeExternalThread: 'Not linked to Happy',
        resumeDuplicate: 'Duplicate binding',
        resumeHappyActive: 'Happy session active',
        resumeHappyInactive: 'Happy session inactive',
        resumeProviderActive: 'Codex active',
