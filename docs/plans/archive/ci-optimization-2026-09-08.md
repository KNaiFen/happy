...
- 后续 PR #75 的 `c30c51d6` / run `34285808878` 官方场景通过，唯一阻塞来自新出现的依赖门禁。最小更新为 `@xmldom/xmldom 0.8.15`、`js-yaml 3.15.2/4.3.2`、Relay `sharp 0.35.4`（对应 libvips 1.3.3）；本地 lockfile-only 和生产依赖门禁通过，保留原三项例外，未安装或编译依赖。
