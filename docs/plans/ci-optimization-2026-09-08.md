...
- 当前分支：`ci/coverage-runtime-optimization-20260908`；A1-A5 已提交为 `d5d6cee2`，B1 已实现并通过源码检查和独立审查；云端验证与交付待完成。
...
首轮 A 项无包版本变化；追加 B1 仅交付 CLI 兼容性补丁及其本机安装，不涉及其他产品发布或生产部署。
