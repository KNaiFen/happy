...
| --- | ---: | --- | --- | --- |
| `happy` | `1.4.56` | [CLI package](../.github/workflows/build-cli-release.yml) | `happy-1.4.56.tgz` | `packages/happy-cli/package.json` 版本变更 |
...
| `happy-server-self-host`（Debian Relay） | `1.1.49` | [Debian 13 relay](../.github/workflows/build-debian13-relay-release.yml) | `happy-relay-server-1.1.49-debian13-amd64.tar.gz` | `packages/happy-server/package.json` 版本变更 |
