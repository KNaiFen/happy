...
| `happy-server-self-host`（Debian Relay） | `1.1.48` | [Debian 13 relay](../.github/workflows/build-debian13-relay-release.yml) | `happy-relay-server-1.1.48-debian13-amd64.tar.gz` | `packages/happy-server/package.json` 版本变更 |
