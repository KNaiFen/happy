...
| --- | ---: | --- | --- | --- |
| `happy` | `1.4.55` | [CLI package](../.github/workflows/build-cli-release.yml) | `happy-1.4.55.tgz` | `packages/happy-cli/package.json` 版本变更 |
...
| `happy-server-self-host`（Debian Relay） | `1.1.47` | [Debian 13 relay](../.github/workflows/build-debian13-relay-release.yml) | `happy-relay-server-1.1.47-debian13-amd64.tar.gz` | `packages/happy-server/package.json` 版本变更 |
