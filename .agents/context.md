...
- Current state: The model-aware Codex reasoning implementation is complete but unreleased. Local Android release builds disable Expo OTA updates, target arm64-v8a devices, and keep a visible high-contrast send action.
